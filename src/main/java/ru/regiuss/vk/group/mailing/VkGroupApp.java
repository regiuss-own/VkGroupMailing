...
import ru.regiuss.vk.group.mailing.screen.*;
...
@Getter
public class VkGroupApp extends RGFXAPP<RootSideBarPane> {
    ...
    public void start() {
        ...
        Text versionText = new Text("Version: 1.0.0");
    ...
    public void applyInitializer(GenericApplicationContext applicationContext) {
        applicationContext.registerBean(VkGroupApp.class, () -> this);
    }

    @Override
    public Class<?> getSpringBootSource() {
        return VkGroupMailing.class;
    }
}
